...
class JSAsset extends Asset {
  ...
  pretransform() {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      if (
        _this2.options.target === 'browser' &&
        BROWSER_RE.test(_this2.contents)
      ) {
        yield _this2.parseIfNeeded();
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      if (_this4.isAstDirty) {
        ...
        if (_this4.options.sourceMaps && generated.rawMappings) {
          ...
          if (_this4.sourceMap) {
            _this4.sourceMap = yield new SourceMap().extendSourceMap(
              _this4.sourceMap,
              rawMap
            );
          } else {
      ...
      if (_this4.options.sourceMaps && !_this4.sourceMap) {
        _this4.sourceMap = new SourceMap().generateEmptyMap(
          _this4.relativeName,
          _this4.contents
        );
      }
