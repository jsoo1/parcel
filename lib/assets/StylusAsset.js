...
function _getDependencies() {
  _getDependencies = (0, _asyncToGenerator2.default)(function*(
    code,
    filepath,
    asset,
    options,
        ...
        (function() {
          var _ref3 = (0, _asyncToGenerator2.default)(function*([
            ...
            if (resolved) {
              ...
              let paths = (options.paths || []).concat(
                dirname(filepath || '.')
              );
            ...
            try {
              for (
                var _iterator2 = found[Symbol.iterator](), _step2;
                ...
                if (!seen.has(resolved)) {
                  ...
                  try {
                    for (
                      var _iterator3 = (yield getDependencies(
                          code,
                          resolved,
                          asset,
                          options,
                      ...
                      let _step3$value = (0, _slicedToArray2.default)(
                          _step3.value,
                          2
                        ),
                        path = _step3$value[0],
...
function _createEvaluator() {
  _createEvaluator = (0, _asyncToGenerator2.default)(function*(
    code,
    asset,
    options
  ) {
    const deps = yield getDependencies(code, asset.name, asset, options);
    const Evaluator = yield localRequire(
...
function mergeBlocks(blocks) {
  ...
  try {
    for (
      var _iterator = blocks[Symbol.iterator](), _step;
