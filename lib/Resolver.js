...
class Resolver {
  ...
  resolve(input, parent) {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      if (parent) {
        ...
        extensions = [
          parentExt,
          ...extensions.filter(ext => ext !== parentExt)
        ];
      }
  ...
  loadRelative(filename, extensions) {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      return (
        (yield _this3.loadAsFile(filename, extensions, pkg)) ||
        (yield _this3.loadDirectory(filename, extensions, pkg)) // eslint-disable-line no-return-await
      );
    })();
  }
      ...
      try {
        ...
        try {
          for (
            ...
            const res =
              (yield _this6.loadAsFile(file, extensions, pkg)) ||
              (yield _this6.loadDirectory(file, extensions, pkg));
  ...
  expandFile(file, extensions, pkg, expandAliases = true) {
    ...
    try {
      for (
        var _iterator3 = extensions[Symbol.iterator](), _step3;
  ...
  loadAlias(filename, dir) {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      if (!_this10.rootPackage) {
        _this10.rootPackage = yield _this10.findPackage(
          _this10.options.rootDir
        );
