...
class JSConcatPackager extends Packager {
  start() {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      try {
        for (
          var _iterator = _this.bundle.assets[Symbol.iterator](), _step;
          ...
          if (
            isExposed ||
            (_this.bundle.entryAsset === asset &&
              _this.bundle.parentBundle &&
              _this.bundle.parentBundle.childBundles.size !== 1)
          ) {
          ...
          try {
            for (
              var _iterator2 = asset.depAssets.values()[Symbol.iterator](),
                _step2;
              ...
              if (
                !_this.bundle.assets.has(mod) &&
                _this.options.bundleLoaders[asset.type]
              ) {
                _this.needsPrelude = true;
                break;
              }
      ...
      if (_this.needsPrelude) {
        if (
          _this.bundle.entryAsset &&
          _this.options.bundleLoaders[_this.bundle.entryAsset.type]
        ) {
  ...
  markUsedExports(asset) {
    ...
    for (let identifier in asset.cacheData.imports) {
      let _asset$cacheData$impo = (0, _slicedToArray2.default)(
          asset.cacheData.imports[identifier],
          2
        ),
      ...
      try {
        for (
          ...
          if (dep.dynamic) {
            ...
            try {
              for (
                var _iterator4 = mod.parentBundle.siblingBundles[
                    Symbol.iterator
                  ](),
                  _step4;
            ...
            if (
              ...
              _this2.options.bundleLoaders[mod.type]
            ) {
  ...
  addDeps(asset, included) {
    ...
    for (let i = 0; i < statements.length; i++) {
      ...
      if (t.isExpressionStatement(statement)) {
        ...
        try {
          for (
            var _iterator6 = this.findRequires(asset, statement)[
                Symbol.iterator
              ](),
              _step6;
    ...
    try {
      for (
        var _iterator7 = reverseDeps[Symbol.iterator](), _step7;
  ...
  wrapModule(asset, statements) {
    ...
    try {
      for (
        var _iterator8 = statements[Symbol.iterator](), _step8;
        ...
        if (t.isVariableDeclaration(node)) {
          ...
          try {
            for (
              var _iterator9 = node.declarations[Symbol.iterator](), _step9;
                ...
                for (
                  var _i = 0,
                    _Object$values = Object.values(
                      t.getBindingIdentifiers(decl.id)
                    );
  ...
  addAssetToBundle(asset) {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      try {
        for (
          var _iterator10 = asset.depAssets.values()[Symbol.iterator](),
            _step10;
  ...
  addBundleLoader(bundleType, parentAsset, dynamic) {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      let bundleLoader = _this4.bundler.loadedAssets.get(
      ...
      if (!_this4.bundle.assets.has(asset)) {
        ...
        _this4.assetPostludes.set(
          asset,
          `${_this4.getExportIdentifier(
            bundleLoader
          )}.register(${JSON.stringify(
            bundleType
          )},${_this4.getExportIdentifier(asset)});\n`
        );
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      try {
        for (
          var _iterator11 = _this5.bundle.assets[Symbol.iterator](), _step11;
      ...
      if (_this5.externalModules.size > 0) {
        ...
        try {
          for (
            var _iterator12 = _this5.externalModules[Symbol.iterator](),
              _step12;
            ...
            let bundle = Array.from(mod.bundles).find(
              b => b.entryAsset === mod
            );
        ...
        let loads = `${_this5.getExportIdentifier(
          bundleLoader
      ...
      let entryExports =
        _this5.bundle.entryAsset &&
        _this5.getExportIdentifier(_this5.bundle.entryAsset);

      if (
        entryExports &&
        _this5.bundle.entryAsset.generated.js.includes(entryExports)
      ) {
        _this5.write(`
      ...
      if (_this5.needsPrelude) {
        ...
        try {
          for (
            var _iterator13 = _this5.exposedModules[Symbol.iterator](), _step13;
            ...
            if (m.cacheData.isES6Module) {
              prepareModule.push(
                `${_this5.getExportIdentifier(m)}.__esModule = true;`
              );
            }
      ...
      try {
        ...
        let preludeCode = _this5.options.minify
          ? prelude.minified
          : prelude.source;
  ...
  findExportModule(id, name, replacements) {
    ...
    let exp =
      ...
      Object.prototype.hasOwnProperty.call(asset.cacheData.exports, name)
        ...
        : null; // If this is a re-export, find the original module.
    ...
    if (wildcards && name !== 'default' && name !== '*') {
      ...
      try {
        for (
          var _iterator14 = wildcards[Symbol.iterator](), _step14;
          !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done);
