...
function _install() {
  _install = (0, _asyncToGenerator2.default)(function*(
    ...
    let _options$installPeers = options.installPeers,
      installPeers =
        _options$installPeers === void 0 ? true : _options$installPeers,
...
function _installPeerDependencies() {
  _installPeerDependencies = (0, _asyncToGenerator2.default)(function*(
    filepath,
    name,
    options
  ) {
...
function _determinePackageManager() {
  _determinePackageManager = (0, _asyncToGenerator2.default)(function*(
    filepath
  ) {
