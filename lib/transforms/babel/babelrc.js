...
function _findBabelRc() {
  _findBabelRc = (0, _asyncToGenerator2.default)(function*(asset) {
    ...
    for (
      var _i = 0, _arr = ['extends', 'overrides', 'test', 'include', 'exclude'];
      _i < _arr.length;
      _i++
    ) {
      let key = _arr[_i];
...
function _inferBabelVersion() {
  _inferBabelVersion = (0, _asyncToGenerator2.default)(function*(
    asset,
    plugins
  ) {
    ...
    try {
      for (
        var _iterator = plugins[Symbol.iterator](), _step;
        ...
        try {
          for (
            var _iterator2 = CORE_DEPS[Symbol.iterator](), _step2;
