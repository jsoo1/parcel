...
module.exports =
  ...
  (function() {
    var _ref = (0, _asyncToGenerator2.default)(function*(asset) {
      ...
      let res = yield postcss(config.plugins).process(
        asset.getCSSAst(),
        config
      );
...
function _getConfig() {
  _getConfig = (0, _asyncToGenerator2.default)(function*(asset) {
    let config = yield asset.getConfig(
  ...
  class ParcelFileSystemLoader extends FileSystemLoader {
    fetch(composesPath, relativeTo) {
      ...
      return (0, _asyncToGenerator2.default)(function*() {
        ...
        const _asset$resolveDepende = asset.resolveDependency(
            importPath,
            relativeTo
          ),
        ...
        const _ref2 = yield _this.core.load(
            source,
            rootRelativePath,
            undefined,
            _this.fetch.bind(_this)
          ),
