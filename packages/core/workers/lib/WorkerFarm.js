...
class WorkerFarm extends EventEmitter {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      if (!worker.stopped) {
        ...
        if (worker.calls.size) {
          ...
          try {
            for (
              var _iterator = worker.calls.values()[Symbol.iterator](), _step;
  ...
  processQueue() {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      try {
        for (
          var _iterator2 = _this2.workers.values()[Symbol.iterator](), _step2;
  ...
  addCall(method, args) {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      _this3.ending = true;
      yield Promise.all(
        Array.from(_this3.workers.values()).map(worker =>
          _this3.stopWorker(worker)
        )
      );
      _this3.ending = false;
      shared = null;
  ...
  persistBundlerOptions() {
    ...
    try {
      for (
        var _iterator3 = this.workers.values()[Symbol.iterator](), _step3;
  ...
  static callMaster(request, awaitResponse = true) {
    return (0, _asyncToGenerator2.default)(function*() {
      if (WorkerFarm.isWorker()) {
        ...
        return (yield WorkerFarm.getShared()).processRequest(request);
      }
    })();
  }
