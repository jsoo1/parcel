...
function rename(scope, oldName, newName) {
  ...
  try {
    for (
      var _iterator = binding.constantViolations[Symbol.iterator](), _step;
      ...
      for (let name in bindingIds) {
        if (name === oldName) {
          ...
          try {
            for (
              var _iterator3 = bindingIds[name][Symbol.iterator](), _step3;
  ...
  try {
    for (
      var _iterator2 = binding.referencePaths[Symbol.iterator](), _step2;
