...
class Bundler extends EventEmitter {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      try {
        ...
        if (isInitialBundle) {
          ...
          try {
            for (
              var _iterator = _this2.entryFiles[Symbol.iterator](), _step;
        ...
        try {
          for (
            var _iterator2 = _this2.loadedAssets.values()[Symbol.iterator](),
              _step2;
        ...
        try {
          for (
            var _iterator3 = _this2.entryAssets[Symbol.iterator](), _step3;
        ...
        for (
          var _i = 0, _changedAssets = changedAssets;
          _i < _changedAssets.length;
          _i++
        ) {
        ...
        _this2.bundleHashes = yield _this2.mainBundle.package(
          _this2,
          bundlesChanged ? null : _this2.bundleHashes
  ...
  loadAsset(asset) {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      if (_this12.delegate.getImplicitDependencies) {
        let implicitDeps = yield _this12.delegate.getImplicitDependencies(
          asset
        );
  ...
  createBundleTree(asset, bundle, dep, parentBundles = new Set()) {
    ...
    let isEntryAsset =
      asset.parentBundle && asset.parentBundle.entryAsset === asset; // If the asset generated a representation for the parent bundle type, and this
    ...
    try {
      for (
        var _iterator4 = asset.depAssets[Symbol.iterator](), _step4;
  ...
  moveAssetToBundle(asset, commonBundle) {
    ...
    for (
      var _i2 = 0, _Array$from = Array.from(asset.bundles);
