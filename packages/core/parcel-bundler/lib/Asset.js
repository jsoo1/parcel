...
class Asset {
  ...
  getPackage() {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      if (!_this4._package) {
        _this4._package = yield _this4.resolver.findPackage(
          path.dirname(_this4.name)
        );
      }
  ...
  process() {
    ...
    return (0, _asyncToGenerator2.default)(function*() {
      ...
      if (!_this8.id) {
        _this8.id =
          _this8.options.production || _this8.options.scopeHoist
            ? t.toIdentifier(md5(_this8.relativeName, 'base64')).slice(0, 4)
            : _this8.relativeName;
      }
